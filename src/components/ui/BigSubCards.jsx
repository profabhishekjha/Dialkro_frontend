...
const BigSubCards = ({ images, title, onClick }) => {
  return (
    <div onClick={onClick} className="container p-10">
      <div className="w-[10vw] rounded-lg border border-gray-200 bg-white shadow dark:border-gray-700 dark:bg-gray-800">
        ...
        <div className="truncate p-2 text-center">
          <a
            href=""
            className="mb-2 overflow-hidden text-center text-sm font-bold capitalize tracking-wide text-gray-900 dark:text-white">
            {title}
          </a>
        </div>
      </div>
